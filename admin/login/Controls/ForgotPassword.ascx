<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ForgotPassword.ascx.cs" Inherits="admin_login_Controls_ForgotPassword" %>
...
<div class="login-help">
    <p>Nếu đã có tài khoản, vui lòng <a href="/admin/login/">Đăng nhập</a>.</p>
</div>
