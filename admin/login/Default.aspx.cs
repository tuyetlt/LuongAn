        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                switch (control)
                {
                    ...
                    case "forgotpassword":
                        {
                            mainControl = LoadControl("~/admin/login/controls/ForgotPassword.ascx");
                            break;
                        }
                    case "resetpassword":
                        {
                            mainControl = LoadControl("~/admin/login/controls/SetPassword.ascx");
                            break;
                        }
                 
                    default:
                        {
                            mainControl = LoadControl("~/admin/login/controls/Login.ascx");
                            break;
                        }
                }
