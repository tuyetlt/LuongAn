<%@ Control Language="C#" AutoEventWireup="true" CodeFile="product-related.ascx.cs" Inherits="template_product_related" %>
<section class="product product__latest-top  moduleProductSlideshow-latest mb-5">
    <div class="container">
        <div class="heading">
          <h2 class="heading__title text-center"><span>SẢN PHẨM TƯƠNG TỰ</span></h2>
        </div>
